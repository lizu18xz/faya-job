...
public class ClusterSupport {
    ...
    public LoadBalance getLoadBalance(JobInfo jobInfo) {
        ...
        log.info("获取服务地址列表,jobid:{},groupId:{},addressList:{}",jobInfo.getId(),jobInfo.getJobGroup(), StringUtils.join(addressList,","));
        ...
        log.info("服务执行负载策略:{}",loadBalance.getClass().getName());
        return loadBalance;
    }
}
